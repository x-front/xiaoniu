...
function _xn_init(){
	$.post("/moreContent/advance",function(result){
			if(result.pp1){
				...
				$(".about-j1-l .about-j1-item1 p:eq(0)").html(result.pp1.more);
			}
			if(result.pp2){
				$(".about-j1-l .about-j1-item2 a:eq(0)").html(result.pp2.title);
				$(".about-j1-l .about-j1-item2 p:eq(0)").html(result.pp2.more);
			}
			if(result.pp3){
				$(".about-j1-l .about-j1-item3 a:eq(0)").html(result.pp3.title);
				$(".about-j1-l .about-j1-item3 p:eq(0)").html(result.pp3.more);
			}
