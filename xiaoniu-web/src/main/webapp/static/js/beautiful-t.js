...
function _xn_init() {
    $.post("/news/list", {type: 2, page: 1, rows: 1, top: 1}, function (a) {
        if (a.resultCode == 0 && a.total > 0) {
            ...
            $(".about-w-link").attr("href", "/static/beautiful-t-inside.html?id=" + b.id)
        }
    }, "json");
    seeMore()
}
function seeMore() {
    ...
    if (a >= 0) {
        ...
        $.post("/news/list", {type: 2, page: targetPage, rows: 2, top: 0}, function (b) {
...
function buildNewsDiv(a, b) {
    var c = '<div class="about-w-item about-w-item' + (b % 2 + 1) + ' wow fadeInUp"><a href="/static/beautiful-t-inside.html?id=' + a.id + '"><div class="about-wh-img"><img src="' + a.banner + '"/></div>';
    c += "<h3>" + a.title + "</h3>";
    c += "<p>" + a.summary + "</p></a>";
    c += '<a href="/static/beautiful-t-inside.html?id=' + a.id + '" class="more">See more<span></span></a>';
    c += "</div>";
    return c
}
function buildNewsDiv1(a, b) {
    var c = '<div class="about-w-item about-w-item' + (b % 2 + 1) + '"><a href="/static/beautiful-t-inside.html?id=' + a.id + '"><div class="about-wh-img"><img src="' + a.banner + '"/></div>';
    c += "<h3>" + a.title + "</h3>";
    c += "<p>" + a.summary + "</p></a>";
    c += '<a href="/static/beautiful-t-inside.html?id=' + a.id + '" class="more">See more<span></span></a>';
    c += "</div>";
