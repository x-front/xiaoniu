...
//			$("#edit-media-showOrHide").removeClass('none');
	...
	function jump(lang){
		location.href='/secure/pageIntrodution/doWhat.html?lang='+lang;
	}
</script>
<style type="text/css">
...
<body>
		...
		<div id="main-div">
			...
			<div class="content-div">
				...
				<div class="description-div">
					<a href="javascript:void(0);" onclick="javascript:initUpdateWhoWindow(8,1,${advance.id })" class="easyui-linkbutton float-right" title="修改" plain="true" iconCls="icon-edit" id="addBtn">修改</a>
				...
				<div class="description-div">
					<a href="javascript:void(0);" onclick="javascript:initUpdateWhoWindow(9,2,${manager.id })" class="easyui-linkbutton float-right" title="修改" plain="true" iconCls="icon-edit" id="addBtn">修改</a>
				...
				<div class="description-div">
					<a href="javascript:void(0);" onclick="javascript:initUpdateWhoWindow(10,3,${princeple.id })" class="easyui-linkbutton float-right" title="修改" plain="true" iconCls="icon-edit" id="addBtn">修改</a>
				...
				<div class="description-div">
					<a href="javascript:void(0);" onclick="javascript:initUpdateWhoWindow(11,4,${honor.id })" class="easyui-linkbutton float-right" title="修改" plain="true" iconCls="icon-edit" id="addBtn">修改</a>
