...
<script type="text/javascript">
	...
	function jump(lang){
		location.href='/secure/pageIntrodution/dongtai.html?lang='+lang;
	}
</script>
<style type="text/css">
		...
		<div id="main-div">
			...
			<div class="content-div">
				<div class="description-div">
					<a href="javascript:void(0);" onclick="javascript:initUpdateWhoWindow(16,0,${news.id })" class="easyui-linkbutton float-right" title="修改" plain="true" iconCls="icon-edit" id="addBtn">修改</a>
					<h2 class="content-h2">最新动态</h2>
					<p class="content-p">${news.introdution }</p>
					<img class="who-img content-img none" alt="" src="${news.extCover }" media="${news.extMedia }">
				</div>
				
				<div class="description-div">
					<a href="javascript:void(0);" onclick="javascript:initUpdateWhoWindow(17,1,${report.id })" class="easyui-linkbutton float-right" title="修改" plain="true" iconCls="icon-edit" id="addBtn">修改</a>
					<h2 class="content-h2">媒体报道</h2>
					<p class="content-p">${report.introdution }</p>
					<img class="who-img content-img none" alt="" src="${report.extCover }" media="${report.extMedia }">
				</div>
