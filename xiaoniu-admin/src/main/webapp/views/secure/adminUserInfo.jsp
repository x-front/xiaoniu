...
<script type="text/javascript">
	commonTable.loadDateURI = "<c:url value='/secure/adminUserInfo/queryAdminUserInfoVOList'/>";
	commonTable.batchUpdateValidURI = "<c:url value='/secure/adminUserInfo/batchDelete?strIds='/>";
	commonTable.batchDeleteURI = "<c:url value='/secure/adminUserInfo/batchUpdateValid?strIds='/>";
	commonTable.updateURI = "<c:url value='/secure/adminUserInfo/updateAdminUserInfo'/>";
	commonTable.insertURI = "<c:url value='/secure/adminUserInfo/insertAdminUserInfo'/>";
