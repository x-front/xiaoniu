...
$.ajax({type:opts.method,url:opts.url,data:_1bb,dataType:"json",beforeSend: function (xhr) {
...
var data={};
data[_458[1]]=_457;
var _459=$.ajax({url:_458[0],dataType:"json",beforeSend: function (xhr) {
    xhr.setRequestHeader($("meta[name='_csrf_header']").attr("content"),$("meta[name='_csrf']").attr("content"));
},data:data,async:false,cache:false,type:"post"}).responseText;
return _459=="true";
...
$.ajax({url:data,data:_4c1,dataType:"json",beforeSend: function (xhr) {
    xhr.setRequestHeader($("meta[name='_csrf_header']").attr("content"),$("meta[name='_csrf']").attr("content"));
},success:function(data){
_4c2(data);
},error:function(){
...
$.ajax({type:opts.method,url:opts.url,data:_76c,dataType:"json",beforeSend: function (xhr) {
    xhr.setRequestHeader($("meta[name='_csrf_header']").attr("content"),$("meta[name='_csrf']").attr("content"));
},success:function(data){
_76d(data);
},error:function(){
...
$.ajax({type:opts.method,url:opts.url,data:_8c8,dataType:"json",beforeSend: function (xhr) {
    xhr.setRequestHeader($("meta[name='_csrf_header']").attr("content"),$("meta[name='_csrf']").attr("content"));
},success:function(data){
_8c9(data);
},error:function(){
...
$.ajax({type:opts.method,url:opts.url,data:_95e,dataType:"json",beforeSend: function (xhr) {
    xhr.setRequestHeader($("meta[name='_csrf_header']").attr("content"),$("meta[name='_csrf']").attr("content"));
},success:function(data){
_95f(data);
},error:function(){
